...
background_image=pygame.image.load('be.jpg')
gameover_image=pygame.image.load('dead.jpg')
tah = pygame.mixer.Sound('bah.wav')
bah = pygame.mixer.Sound('bah.wav')
...
class Tank:
    ...
    def dead(self):
            ...
            font = pygame.font.SysFont("Calibri", 30)
            text = font.render(str(self.name) + ' is looser... ', True, (255,255,255))
